...
export function createDecorator(decorator: DecoratorFunction<SolidRenderer>): Decorator {
    return decorator as Decorator;
}

/** Use for decorators that return JSX. Ensures they run only once per story mount. */
export function createJSXDecorator(decorator: DecoratorFunction<SolidRenderer>): Decorator {
